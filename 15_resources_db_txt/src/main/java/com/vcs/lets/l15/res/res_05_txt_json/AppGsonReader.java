package com.vcs.lets.l15.res.res_05_txt_json;
...
public class AppGsonReader {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		for (String key : mo.getPersons().keySet()) {

			System.out.println(mo.getPersons().get(key).getName());
			System.out.println(mo.getPersons().get(key).getAge());
			System.out.println();
